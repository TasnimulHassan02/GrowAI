      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {datasets.map((dataset, i) => (
            <div
              key={i}
              className="group relative bg-base-100 rounded-2xl border border-base-300 overflow-hidden hover:shadow-1xl hover:-translate-y-1 transition-all duration-300"
            >
              {/* Badge (if any) */}
              {dataset.badge && (
